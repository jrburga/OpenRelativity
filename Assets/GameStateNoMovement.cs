...
public class GameStateNoMovement : MonoBehaviour
{
	...
	public void LateUpdate()
	{
		...
		if (!movementFrozen)
		{
			...
			{
//				transform.parent.gameObject.GetComponent<Rigidbody>().velocity = -1*(playerVelocityVector / (float)sqrtOneMinusVSquaredCWDividedByCSquared);
			}
